...
class Minimap(object):
   ...
   def __init__(self, xxx_todo_changeme, xxx_todo_changeme1):
      ...
      (coordinate_x, coordinate_y) = xxx_todo_changeme
      (size_x, size_y) = xxx_todo_changeme1
      self.mini_screen = View(State.screen.surface, pygame.Rect(coordinate_x, coordinate_y, size_x, size_y))
...
class gameScene(Engine):
   ...
   def constructScene(self):
      resolution = self.features['resolution']
      Engine.__init__(self,self.screen,self.features['resolution'],0,self.features['strcaption'],objects.ourHero("horseman","horseman",(500, 770), resolution),None,None,None, self.features['tile_size'], self.features['map_size'],self.features['FPS'])
      ...
      self.faux_avatar = objects.ourHero("horseman","horseman",self.camera.target.position, 0)
   ...
   def update(self, dt):
      ...
      #self.avatar.position(camera.position)
