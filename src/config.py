...
class Config_Manager:
    ...
    def load_parameters(self, config_file):
        ...
        self.parameters = {'resolution': resolution, 'strcaption': strCaption,
                           'caption': NULL, 'tile_size': tile_size,
                           'map_size': map_size, 'minimap_pos': minimap_pos,
                           'minimap_size': minimap_size, 'FPS': FPS,
                           'version': version, 'fullscreen': fullscreen}
    ...
    def initResolution(self, config_file):
        res = subprocess.run("./src/tools/activescreen",
